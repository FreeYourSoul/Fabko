...
//
// Created by FyS on 03/05/23. License 2022-2024
//
...
struct variable {
    ...
    friend std::span<variable> conj(std::span<variable>, std::vector<std::string> token);
    friend std::span<variable> disj(std::span<variable>, std::vector<std::string> token);
