...
TEST_CASE("algorithm_testcase string") {
  ...
  SECTION("basic split_string test") {
    ...
    fabko::split_string("this;contains;three;semi-column", ";", [&counter](const std::string& fragment) { ++counter; });
    REQUIRE(4 == counter);
  ...
  SECTION("split_string no occurrence") {
    ...
    std::uint32_t counter = 0;
    std::string value;
    fabko::split_string("this", ";", [&counter, &value](const std::string& fragment) { ++counter; value = fragment; });
    REQUIRE(1 == counter);
    REQUIRE("this" == value);
  ...
  SECTION("split_string no occurrence") {
    ...
    fabko::split_string(";", ";", [&counter, &values](const std::string& fragment) { ++counter; values.emplace_back(fragment); });
    REQUIRE(2 == counter);
  ...
  SECTION("basic split_string check fragment") {
    ...
    fabko::split_string("this;contains;three;semi-column", ";", [&fragments](std::string fragment) { fragments.emplace_back(std::move(fragment)); });
